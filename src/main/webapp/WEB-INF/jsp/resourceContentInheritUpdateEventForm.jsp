...
<body>
  ...
  <h2>Test Resource ContentInherit Update event</h2>
  <form:form action="resourceContentInheritUpdateEvent"
    ...
    <table class="colored">
      ...
      <tr>
        <td>newResourceHasContentInherit</td>
        <td><form:checkbox path="resourceHasContentInherit" /></td>
      </tr>
      <tr>
