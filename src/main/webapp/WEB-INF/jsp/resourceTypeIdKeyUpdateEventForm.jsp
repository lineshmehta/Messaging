...
<h2>Test Resource TypeId Key Update event</h2>
<form:form action="resourceTypeIdKeyUpdateEvent" modelAttribute="resourceForm" >
    <table class="colored">
      <tr>
        <td>ResourceId</td>
      ...
      <tr>
        <td>newResourceTypeIdKey</td>
        <td><form:input path="resourceTypeIdKey"/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><form:input path="oldResourceTypeId" />
        </td>
      </tr>
      <tr>
